...
sleep 5
# Secrets-block
SECRET_VALUE=$(aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:us-east-1:630058354226:secret:test-srZ7pu --region us-east-1 | jq -r .SecretString)
